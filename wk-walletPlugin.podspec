#
#  Be sure to run `pod spec lint wk-walletPlugin.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Dogd"
  # s.authors            = { "Dogd" => "lcl1994@outlook.com" }
  # s.social_media_url   = "http://twitter.com/Dogd"
  ...
  s.source_files  =  "Wiccwallet.framework/*.{h,m}"
